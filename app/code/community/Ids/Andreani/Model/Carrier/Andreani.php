...
class Ids_Andreani_Model_Carrier_Andreani extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {
    ...
    public function consultarSucursales($params,$modo) {
        ...
        try {
            ...
            if (Mage::getStoreConfig('carriers/andreaniconfig/testmode',Mage::app()->getStore()) == 1) {
                $urlSucursales  = Mage::helper('andreani')->getWSMethodUrl(Ids_Andreani_Helper_Data::SUCURSALES,Ids_Andreani_Helper_Data::ENVMODTEST);
                $soapVersion  	= Mage::helper('andreani')->getSoapVersion(Ids_Andreani_Helper_Data::SUCURSALES,Ids_Andreani_Helper_Data::ENVMODTEST);
            } else {
                $urlSucursales  = Mage::helper('andreani')->getWSMethodUrl(Ids_Andreani_Helper_Data::SUCURSALES,Ids_Andreani_Helper_Data::ENVMODPROD);
